-- Fix bug: Insert buy_price_snapshot during checkout to ensure COGS and Profit are calculated correctly
...
BEGIN
  ...
  LOOP
    ...
    -- PERBAIKAN BUG: buy_price_snapshot sekarang dimasukkan
